...
public class Segment {
	...
	public Segment(Point1 left, Point1 right) {
		...
		Point1 pRight = new Point1(right);

		Point1 pLeft = new Point1(left);
	...
	public Segment(int xLeft, int yLeft, int xRight, int yRight) {
		...
		Point1 pRight = new Point1(xRight, yRight);

		Point1 pLeft = new Point1(xLeft, yLeft);
	...
	public Segment(Segment other) {
		...
		Point1 pRight = new Point1(other._poRight);

		Point1 pLeft = new Point1(other._poLeft);
